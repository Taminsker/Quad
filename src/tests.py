...
method = [q.pt_milieu, q.trapeze, q.simpson, q.gauss_legendre_2, q.gauss_legendre_3]
method_name = ["pt_milieu", "trapezes", "Simpson", "Gauss-Legendre_2pts", "Gauss-Legendre_3pts"]
...
for meth_q, meth_name in zip (method, method_name):
    ...
    plt.title("Test de conv. méthode {} sur des f-tests [{}, {}]".format(meth_name, a, b))
    plt.legend()
    plt.xlabel("N")
    plt.ylabel("Erreur")
    plt.grid()
    ...
    # plt.show()
    plt.savefig("../img/{}.png".format (meth_name))
...
for k in np.arange(7):
    ...
    # Utilisez une des lignes ci-dessous pour voir/enregistrer le graphique
    # plt.show()
    plt.savefig("../img/x{}.png".format (k))
...
for fun, fun_int, fun_name in zip (function, function_int, function_name):
    ...
    # Utilisez une des lignes ci-dessous pour voir/enregistrer le graphique
    # plt.show()
    plt.savefig("../img/{}.png".format (fun_name))
